...
def main():
    ...
    which asks "What is the optimal set of routes for a fleet of vehicles to traverse in order to deliver
    to a given set of customers?". It generalizes the well-known traveling salesman problem (TSP).
    This app uses Google's OR-Tools to find a solution to the VRP and visualize the routes.
    """)
    ...
    num_vehicles = st.slider('Select Number of Vehicles', min_value=1, max_value=10, value=4)
